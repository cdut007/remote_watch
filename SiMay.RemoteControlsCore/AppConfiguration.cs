...
namespace SiMay.RemoteControlsCore
{
    ...
    public class ManagerAppConfig : AbstractAppConfigBase
    {
        ...
        Dictionary<string, string> _defaultConfig = new Dictionary<string, string>()
        {
            ...
            { "AccessKey", "5200" },
            { "NotAllowDesktopRecord","" },
            { "AutoSaveInterval", (60 * 30).ToString() },//30分钟
            { "RecordFileSaveRoot",Environment.CurrentDirectory },
            { "RecordFileFormat", "0" },//默认H264，1=MP4
            { "RecordRate", "10"}
        };
    ...
    public class AppConfiguration
    {
        ...
        public static string NotAllowDesktopRecord
        {
            get { return SysConfig.GetConfig("NotAllowDesktopRecord"); }
            set { SysConfig.SetConfig("NotAllowDesktopRecord", value); }
        }

        public static int AutoSaveInterval
        {
            get { return int.Parse(SysConfig.GetConfig("AutoSaveInterval")); }
            set { SysConfig.SetConfig("AutoSaveInterval", value.ToString()); }
        }

        public static string RecordFileSaveRoot
        {
            get { return SysConfig.GetConfig("RecordFileSaveRoot"); }
            set { SysConfig.SetConfig("RecordFileSaveRoot", value); }
        }

        public static int RecordFileFormat
        {
            get { return int.Parse(SysConfig.GetConfig("RecordFileFormat")); }
            set { SysConfig.SetConfig("RecordFileFormat", value.ToString()); }
        }

        public static int RecordRate
        {
            get { return int.Parse(SysConfig.GetConfig("RecordRate")); }
            set { SysConfig.SetConfig("RecordRate", value.ToString()); }
        }
    }
}