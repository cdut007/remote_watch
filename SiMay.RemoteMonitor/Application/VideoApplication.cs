...
namespace SiMay.RemoteMonitor.Application
{
    ...
    public partial class VideoApplication : Form, IApplication
    {
        ...
        {
            var targetDirectory = Path.Combine(AppConfiguration.RecordFileSaveRoot, VideoAppAdapterHandler.GroupName, VideoAppAdapterHandler.OriginName);
            ...
            videoWriter.Open(fileName, _videoFrameWidth, _videoFrameHeight, AppConfiguration.RecordRate, (AppConfiguration.RecordFileFormat == 0 ? VideoCodec.H264 : VideoCodec.MPEG4));
