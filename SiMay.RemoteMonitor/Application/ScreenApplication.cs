...
namespace SiMay.RemoteMonitor.Application
{
    ...
    public partial class ScreenApplication : Form, IApplication
    {
        ...
        private async void CreateDesktopRecordThread()
        {
            ...
            videoWriter.Open(fileName, _srcImageWidth, _srcImageHeight, AppConfiguration.RecordRate, (AppConfiguration.RecordFileFormat == 0 ? VideoCodec.H264 : VideoCodec.MPEG4));
