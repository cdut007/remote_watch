...
namespace SiMay.RemoteMonitor
{
    internal static class Program
    {
        ...
        {
            var logFileName = Path.Combine(Environment.CurrentDirectory, DateTime.Now.ToFileTime() + ".log");
            File.WriteAllText(logFileName, msg + Environment.NewLine + ex.Message + Environment.NewLine + ex.StackTrace);
        }
    }
}